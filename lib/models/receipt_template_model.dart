...
class ReceiptTemplateModel {
  ...
  factory ReceiptTemplateModel.fromMap(Map<String, dynamic> map) {
    return ReceiptTemplateModel(
      ...
      billHeaderSize: (map['billHeaderSize'] as num?)?.toDouble() ?? 18.0,
      billShowStoreAddress: map['billShowStoreAddress'] ?? true,
      billAddressSize: (map['billAddressSize'] as num?)?.toDouble() ?? 14.0,
      billShowStorePhone: map['billShowStorePhone'] ?? true,
      billPhoneSize: (map['billPhoneSize'] as num?)?.toDouble() ?? 14.0,
      billTitleSize: (map['billTitleSize'] as num?)?.toDouble() ?? 16.0,
      billShowCashierName: map['billShowCashierName'] ?? true,
      billShowCustomerName: map['billShowCustomerName'] ?? true,
      billTextSize: (map['billTextSize'] as num?)?.toDouble() ?? 14.0,
      billItemNameSize: (map['billItemNameSize'] as num?)?.toDouble() ?? 14.0,
      billItemDetailSize: (map['billItemDetailSize'] as num?)?.toDouble() ?? 13.0,
      billShowTax: map['billShowTax'] ?? true,
      billShowSurcharge: map['billShowSurcharge'] ?? true,
      billShowDiscount: map['billShowDiscount'] ?? true,
      billTotalSize: (map['billTotalSize'] as num?)?.toDouble() ?? 14.0,
