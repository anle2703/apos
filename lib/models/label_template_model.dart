...
class LabelTemplateModel {
  ...
  LabelTemplateModel({
    ...
    this.retailHeaderSize = 6.0,
    this.retailHeaderBold = true,
    this.retailProductSize = 6.0,
    this.retailProductBold = false,
    this.retailBarcodeHeight = 13.0,
    this.retailBarcodeWidth = 70.0,
    this.retailCodeSize = 7.0,
    this.retailCodeBold = false,
    this.retailPriceSize = 7.0,
